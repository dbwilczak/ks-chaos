...
### H-sets at periodic points
  ...
  - [**hsets/N1.txt**](hsets/N1.txt) - the h-set centred at an approximate period two point $`a^1`$ of Poincare map on the section $`a_1=0`$
  - [**hsets/N2.txt**](hsets/N2.txt) - the h-set centred at an approximate period four point $`a^2`$ of Poincare map on the section $`a_1=0`$
