...
> $`\frac{d}{dt}a_k = k^2(1-\nu k^2)a_k - k \sum_{1\leq n\leq k-1}a_na_{k-n} + 2k \sum_{n\geq 1} a_n a_{k+n},`$

where $`(a_k)_{k\geq 1}`$ are the Fourier coefficients of the solutions to the KS PDE. Symbolic dynamics for the above system is verified by means of the method of covering relations (see article for details).
...
- Trajectory of approximate fixed point $`a^1`$ intersects twice the section $`a_1=0`$. The sets $`N^1`$ and $`M`$ are centred at $`a^1`$ and $`P(a^1)`$, respectively.
- Trajectory of approximate period two point $`a^2`$ intersects four times the section $`a_1=0`$. The sets $`N^2, K_1,K_2,K_3`$ are centred at $`a^2,P(a^2),P^2(a^2)`$ and $`P^3(a^2)`$, respectively.

>| <!-- -->      | <!-- -->        | <!-- -->      |<!-- -->      |<!-- -->      |<!-- -->      |
>|:-------------:|:---------------:|:-------------:|:-------------:|:-------------:|:-------------:|
>|[**N1.txt**](hsets/N1.txt) | [**N2.txt**](hsets/N2.txt)| [**M.txt**](hsets/M.txt)| [**K1.txt**](hsets/K1.txt)| [**K2.txt**](hsets/K2.txt) | [**K3.txt**](hsets/K3.txt) |

### H-sets along $`a^1\to a^2`$ heteroclinic chain
Each h-set $`N^i_{1\to2},\ i=0,\ldots,10`$ from the article is defined in the corresponding set **Ni_12.txt**
>| <!-- -->      | <!-- -->        | <!-- -->      |<!-- -->      |<!-- -->      |<!-- -->      |
>|:-------------:|:---------------:|:-------------:|:-------------:|:-------------:|:-------------:|
>| [**N0_12.txt**](hsets/N0_12.txt) | [**N1_12.txt**](hsets/N1_12.txt)| [**N2_12.txt**](hsets/N2_12.txt)| [**N3_12.txt**](hsets/N3_12.txt)| [**N4_12.txt**](hsets/N4_12.txt)| [**N5_12.txt**](hsets/N5_12.txt)|
>| [**N6_12.txt**](hsets/N6_12.txt) | [**N7_12.txt**](hsets/N7_12.txt)| [**N8_12.txt**](hsets/N8_12.txt)| [**N9_12.txt**](hsets/N9_12.txt)| [**N10_12.txt**](hsets/N10_12.txt)|

### H-sets along $`a^2\to a^1`$ heteroclinic chain
Each h-set $`N^i_{2\to1},\ i=0,\ldots,10`$ from the article is defined in the corresponding set **Ni_21.txt**
>| <!-- -->      | <!-- -->        | <!-- -->      |<!-- -->      |<!-- -->      |<!-- -->      |
>|:-------------:|:---------------:|:-------------:|:-------------:|:-------------:|:-------------:|
>| [**N0_21.txt**](hsets/N0_21.txt) | [**N1_21.txt**](hsets/N1_21.txt)| [**N2_21.txt**](hsets/N2_21.txt)| [**N3_21.txt**](hsets/N3_21.txt)| [**N4_21.txt**](hsets/N4_21.txt)| [**N5_21.txt**](hsets/N5_21.txt)|
>| [**N6_21.txt**](hsets/N6_21.txt) | [**N7_21.txt**](hsets/N7_21.txt)| [**N8_21.txt**](hsets/N8_21.txt)| [**N9_21.txt**](hsets/N9_21.txt)| [**N10_21.txt**](hsets/N10_21.txt)|
...
- [**output/outStablePeriodicOrbitDim15**](output/outStablePeriodicOrbitDim15) - validation in effective dimension 15 and larger tolerance 1e-7 of the PDE solver
- [**output/outStablePeriodicOrbitDim18**](output/outStablePeriodicOrbitDim18) - validation in effective dimension 18 and smaller tolerance 1e-11 of the PDE solver

By default the program runs computation in dimension 15 (much faster) - see **main** function in [**progs/check_stable_po.cpp**](progs/check_stable_po.cpp) for details.
...
___
## Source code of the program. <a name="code"></a>
